...
func UpdatelayerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateLayerRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=OpsWorks_20130218.UpdateLayer", cfg.BaseURL)
...
func CreateUpdatelayerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=OpsWorks_20130218_UpdateLayer",
		mcp.WithDescription("<p>Updates a specified layer.</p> <p> <b>Required Permissions</b>: To use this action, an IAM user must have a Manage permissions level for the stack, or an attached policy that explicitly grants permissions. For more information on user permissions, see <a href="https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html">Managing User Permissions</a>.</p>"),
		...
		mcp.WithString("Shortname", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatelayerHandler(cfg),
	}
}
